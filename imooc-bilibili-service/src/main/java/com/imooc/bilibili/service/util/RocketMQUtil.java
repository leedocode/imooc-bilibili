...
public class RocketMQUtil {
    ...
    public static void asyncSendMsg(DefaultMQProducer producer, Message msg) throws InterruptedException, RemotingException, MQClientException {
        int messageCount = 2;
